    ...
    <div class="main-center">
        <section class="explain clearfix">
            <div class="explain-txt">
                ...
                <ul>
                    <li>この課題では、単語に対する印象を回答していただきます。</li>
                    <li>実験が開始すると、一つの単語または短い動画が画面に表示されます。</br>
                    単語ならば5秒間、動画ならば10秒～15秒間映し出されます。</li>
                    <li>単語または動画を見たときの自分の感情として最もあてはまる位置にカーソルを動かし、クリックして回答してください。</br>
                    マップが表示されたあと、5秒以内を目安に回答してください。</br>
                    急いで回答する必要はありませんので、その時の自分の気持ちに最も近い位置を選択してください。</li>
                    <li>実験時間はおよそ100分間です。1つのセッション（8分〜12分）が終了するごとに1分間の休憩時間が設けられます。</br>
                ...
                <header><h2></br>評価マップの使い方</h2></header>
                <ul>
                    <li>単語または動画を見ていただいたあと、右のような二つの軸を持つマップが表示されます。</br>
                    ...
                    <li>単語または動画を見た後の自分の感情として最もあてはまる位置にカーソルを動かし、クリックして回答してください。</br>
                    マップが表示されたあと、5秒以内を目安に回答してください。</br>
                    急いで回答する必要はありませんので、その時の自分の気持ちに最も近い位置を選択してください。</li>
                </ul>
            </div>
